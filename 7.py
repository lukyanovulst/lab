...
from tkinter.scrolledtext import ScrolledText # Правильный импорт
...
def calculate_distributions():
    ...
    # Нахождение оптимального решения - не нужно в базовом варианте
